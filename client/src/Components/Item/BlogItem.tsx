    ...
    return (
        <div className={`flex items-center justify-between  min-h-44 w-full border-b dark:border-b dark:border-b-neutral-800 `}>
            <div className={`flex flex-col gap-2 mb-2`}>
                ...
                <div className={`flex gap-2 items-center`}>
                    <p className={`text-sm text-primary dark:text-violet-500`}>{date.toDateString()}</p>
                    <p className={`p-1 px-2 text-sm bg-primary dark:bg-third dark:text-white rounded-3xl`}>{avgReadingTime}</p>
