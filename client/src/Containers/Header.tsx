    ...
    return (
        <div className={'flex flex-col justify-center  h-[450px] bg-primary dark:bg-teal-600 w-full  dark:border-b dark:border-b-neutral-800 '+ addTransition}>
            <div className={`mt-3 gap-5 px-12 flex flex-col`}>
                ...
                <span className={`text-6xl font-bold font-playfair text-white dark:text-black`}>Experience Reading</span>
                <span className={`text-2xl font-playfair text-white dark:text-black `}>Learn, read, think etc</span>
                </div>
